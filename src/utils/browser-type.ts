/**
 * @description Get user's browser version and system information
 * @description Get user's browser version and system information
...
export default function BrowserType(lang: 'zh-cn' | 'en' = 'en') {
  ...
  const [engine = 'unknow', supporter = 'unknow'] = new Map([
    ...
    [testUa(/trident|compatible|msie/g), ['trident', 'iexplore']], // [Trident engine, IE browser]
  ...
  const [shell = 'none', shellVs = 'unknow'] = new Map([
    ...
    [testUa(/lbbrowser/g), ['liebao', 'unknow']], // [Liebao browser (no version),]
